...
CITIES = {
  ...
  "ellenton": {
    ...
    "county": "Manatee County",
    "zips": ["34222"],
    "neighborhoods": ["East Ellenton","Colony Cove","Covered Bridge Estates","Oakley Place","Gillette","North River Estates","Glen Creek","Riverfront Ellenton","Willow Walk","Foxbrook"],
    "context": "<strong>Ellenton</strong> is a riverfront community in Manatee County (ZIP 34222) sitting directly next to Palmetto — Triangle Flooring's home base — which makes it one of the fastest, easiest markets for us to serve. Ellenton has a high concentration of 55+ and resort-style communities like Colony Cove, plus deed-restricted single-family neighborhoods and riverfront homes along the Manatee River. That demographic drives heavy demand for <strong>carpet replacement</strong> and easy-clean, waterproof luxury vinyl plank — old carpet pulled out and replaced with LVP or porcelain tile that shrugs off Florida humidity and is friendly for aging-in-place. Because we're minutes away, Ellenton homeowners get same-week estimates and fast scheduling on hardwood, vinyl plank, tile, laminate, and stair tread work.",
    "landmarks": "Ellenton Premium Outlets, Gamble Plantation Historic State Park, Manatee River, Fort Hamer Bridge, Ellenton-Gillette Road",
  },
  "ruskin": {
    "name": "Ruskin",
    "county": "Hillsborough County",
    "zips": ["33570","33573"],
    "neighborhoods": ["Hawks Point","Mira Lago","Bahia Lakes","Shell Point","Antigua Cove","River Bend","Spencer Creek","Wellington North","Cypress Creek","College Chase","Brookside Estates","Belmont"],
    "context": "<strong>Ruskin</strong> is one of South Hillsborough County's fastest-growing communities (ZIP 33570/33573), having nearly tripled in population since 2000 to over 34,000 residents — overwhelmingly young families buying new construction. That growth makes Ruskin a prime, low-competition flooring market: most projects are upgrades from builder-grade carpet and sheet vinyl to <strong>waterproof luxury vinyl plank</strong>, porcelain tile, and engineered hardwood. Triangle Flooring installs floors built for Florida heat and humidity across Ruskin's master-planned neighborhoods like Hawks Point, Mira Lago, and Bahia Lakes, with free in-home estimates within 24 hours and a written 1-year labor warranty.",
    "landmarks": "Little Manatee River, E.G. Simmons Regional Park, Ruskin Family Drive-In, Apollo Beach Nature Preserve, Tampa Bay",
  },
  "apollo-beach": {
    "name": "Apollo Beach",
    "county": "Hillsborough County",
    "zips": ["33572"],
    "neighborhoods": ["MiraBay","Waterset","Symphony Isles","Bimini Bay","Andalucia","Covington Park","Harbour Isles","Lake St. Clair","Caloosa Creek","Golf &amp; Sea Village","Southshore Falls"],
    "context": "<strong>Apollo Beach</strong> is an affluent waterfront and boating community in Hillsborough County (ZIP 33572), built around canals with direct access to Tampa Bay. Premier neighborhoods like MiraBay (nearly 1,700 homes) and the fast-growing Waterset community drive strong demand for upscale flooring — wide-plank engineered hardwood, large-format porcelain tile, and high-end waterproof luxury vinyl plank. Waterfront homes here need careful subfloor moisture management because of canal humidity and salt air, which is exactly where Triangle Flooring's Florida-specific install process pays off. We serve all of Apollo Beach with free 24-hour estimates on hardwood, LVP, tile, laminate, stairs, and floor repair.",
    "landmarks": "MiraBay, Apollo Beach Nature Preserve, Manatee Viewing Center, Apollo Beach Marina, Tampa Bay",
  },
  "sun-city-center": {
    "name": "Sun City Center",
    "county": "Hillsborough County",
    "zips": ["33573"],
    "neighborhoods": ["Kings Point","The Preserve at La Paloma","Fairway Pointe","Renaissance","Caloosa Country Club","Cypress Creek","Verona","Belmont","Sun City Center Central","Sun City Center West"],
    "context": "<strong>Sun City Center</strong> is one of Florida's largest 55+ retirement communities (ZIP 33573) in Hillsborough County, with a population that has grown roughly 60% since 2010 to nearly 31,000 residents and a median age of 70. For flooring, this is a high-demand, low-competition goldmine: thousands of homes still have original carpet that owners want gone. The number-one request here is <strong>carpet replacement</strong> — pulling out old, hard-to-clean carpet and installing slip-resistant, easy-care waterproof luxury vinyl plank, porcelain tile, and low-profile transitions that are safe and accessible for aging in place. Triangle Flooring offers free in-home estimates, fast scheduling, and clean, respectful crews across Kings Point and every Sun City Center neighborhood.",
    "landmarks": "Kings Point, Sun City Center Community Hall, SCC golf courses, Little Manatee River State Park, Cypress Creek Golf Club",
  },
  "north-port": {
    "name": "North Port",
    "county": "Sarasota County",
    "zips": ["34286","34287","34288","34289","34291"],
    "neighborhoods": ["Wellen Park","West Villages","Warm Mineral Springs","Bobcat Trail","Heron Creek","Lakeside Plantation","Talon Bay","Cedar Grove","Watercress Cove","Renaissance at West Villages","Gran Paradiso"],
    "context": "<strong>North Port</strong> is one of the fastest-growing cities in the United States (ZIPs 34286–34291) in southern Sarasota County, with more than 74,000 residents and the booming Wellen Park master-planned community adding thousands of new homes. Most flooring projects here are new-construction upgrades — swapping builder-grade carpet and laminate for premium engineered hardwood, wide-plank <strong>waterproof luxury vinyl plank</strong>, and large-format porcelain tile — plus carpet replacement in established neighborhoods like Bobcat Trail and Heron Creek. Triangle Flooring serves all of North Port and Wellen Park with free 24-hour estimates and floors specified to last in Florida's heat and humidity.",
    "landmarks": "Wellen Park Downtown, Warm Mineral Springs, CoolToday Park (Atlanta Braves), Myakkahatchee Creek Environmental Park, Legacy Trail",
  },
  "nokomis": {
    "name": "Nokomis",
    "county": "Sarasota County",
    "zips": ["34275"],
    "neighborhoods": ["Calusa Lakes","Sorrento East","Sorrento Woods","Bay Point","Casey Key","Hidden Bay","Venetian Golf &amp; River Club","Toscana Isles","Magnolia Bay","Milano","Palmero"],
    "context": "<strong>Nokomis</strong> is an affluent coastal community in Sarasota County (ZIP 34275) between Osprey and Venice — often called one of the area's best-kept real estate secrets. It blends ultra-luxury barrier-island homes on Casey Key with sought-after golf and gated communities like Calusa Lakes, the Sorrento neighborhoods, and Venetian Golf &amp; River Club. Nokomis homeowners favor premium finishes: wide-plank European White Oak hardwood, custom herringbone patterns, and large-format porcelain tile, with <strong>waterproof luxury vinyl plank</strong> popular for coastal and rental properties. With low local competition for quality installers, Triangle Flooring is well positioned here — free 24-hour estimates and a 1-year written labor warranty on every job.",
    "landmarks": "Nokomis Beach, Casey Key, Oscar Scherer State Park, Legacy Trail, Venetian Waterway Park",
  },
}
...
We're particularly skilled at LVP installations in <strong>short-term rental properties</strong> across Anna Maria Island, Siesta Key, and Lido Key — where waterproof, easy-to-clean flooring that looks great in listing photos drives nightly rates. We've completed 100+ STR reflooring projects in the last three years, and we know how to coordinate around peak booking seasons to minimize lost revenue.""",
    ...
    "pricing_rows": [
      ("Standard LVP (4mm, 12-mil wear)", "$1.50–$3/sq ft", "Builder-grade, rental-friendly"),
      ("Mid-Range LVP/SPC (6mm, 20-mil)", "$2.50–$5/sq ft", "Most popular for residential"),
      ("Premium SPC (8mm, 22+mil wear)", "$4–$7/sq ft", "Pet-proof, lifetime residential warranty"),
      ("Luxury Wide-Plank LVP (9″+)", "$5–$9/sq ft", "Premium look, hardwood-mimicking"),
      ("Glue-Down LVP (commercial)", "$3–$6/sq ft", "STRs, AirBnBs, high-traffic"),
